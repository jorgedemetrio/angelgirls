...
<form  action="<?php echo(JRoute::_('index.php?option=com_angelgirls&view=perfil&task=salvarLocacao')); ?>" method="post" name="dadosFormLocacao" id="dadosFormLocacao" class="form-validate" role="form" data-toggle="validator" enctype="multipart/form-data" >
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<input class="form-control" data-validation="required alphanumeric" required value="<?php echo(JRequest::getVar('nome')); ?>" style="width: 90%;" type="text" name="nome"  id="nome" maxlength="250" title="<?php echo JText::_('Nome da loca&ccedil;&atilde; da sess&atilde;o. Ex: Model Amor, Av Paulista'); ?>" placeholder="<?php echo JText::_('Nome da loca&ccedil;&atilde; da sess&atilde;o. Ex: Model Amor, Av Paulista'); ?>"/>
	</div>
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-10">
		...
		<input class="form-control" data-validation="required" required style="width: 90%;" type="text" name="endereco"  id="endereco"  value="<?php echo(JRequest::getVar('endereco')); ?>"  maxlength="250" title="<?php echo JText::_('Endere&ccedil;o da loca&ccedil&atilde;o da sess&atilde;o'); ?>" placeholder="<?php echo JText::_('Endere&ccedil;o da loca&ccedil&atilde;o da sess&atilde;o'); ?>"/>
	</div>
	...
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<input class="form-control" data-validation="required" required style="width: 90%;" type="text" name="bairro"  value="<?php echo(JRequest::getVar('bairro')); ?>" id="bairro" maxlength="10" title="<?php echo JText::_('Bairro  da loca&ccedil&atilde;o da sess&atilde;o'); ?>" placeholder="<?php echo JText::_('Bairro da loca&ccedil&atilde;o da sess&atilde;o'); ?>"/>
	</div>
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<input class="form-control validate-cep" data-validation="required" required pattern="[0-9]{5}-[0-9]{3}"  style="width: 90%;" type="text" name="cep"  id="cep" value="<?php echo(JRequest::getVar('cep')); ?>" maxlength="9" title="<?php echo JText::_('CEP  da loca&ccedil&atilde;o da sess&atilde;o'); ?>" placeholder="<?php echo JText::_('CEP da loca&ccedil&atilde;o da sess&atilde;o'); ?>"/>
	</div>
