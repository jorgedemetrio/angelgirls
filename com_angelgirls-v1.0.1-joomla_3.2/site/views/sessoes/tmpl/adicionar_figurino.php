...
<form  action="<?php echo(JRoute::_('index.php?option=com_angelgirls&view=perfil&task=salvarFigurino')); ?>" method="post" name="dadosFormFigurino" id="dadosFormFigurino" class="form-validate" role="form" data-toggle="validator" enctype="multipart/form-data" >
	...
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<input class="form-control" data-validation="required alphanumeric" required style="width: 90%;" type="text" name="nome" value="<?php echo(JRequest::getVar('nome')); ?>"  id="nome" maxlength="250" title="<?php echo JText::_('Nome do figurino'); ?>" placeholder="<?php echo JText::_('Nome do figurino'); ?>"/>
	</div>
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<textarea class="form-control" data-validation="required alphanumeric" required style="width: 90%;" type="text" name="descricao"  id="descricao" maxlength="250" title="<?php echo JText::_('Descri&ccedil;&atilde;o do figurino'); ?>" placeholder="<?php echo JText::_('Descri&ccedil;&atilde;o do figurino'); ?>"><?php echo(JRequest::getVar('descricao')); ?></textarea>
	</div>
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
