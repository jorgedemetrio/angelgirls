...
JFactory::getDocument()->addScript(JURI::base( true ).'/components/com_angelgirls/assets/js/cadastro_fotografo.js'); 
...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate" role="form" data-toggle="validator" enctype="multipart/form-data" >
	...
	<h1><?php echo JText::_('Formul&aacute;rio de cadastro para fotografos'); ?></h1>
