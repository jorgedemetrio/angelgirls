...
<?php if(isset($perfil)) : ?>
	  ...
	  <li role="presentation inbox"<?php echo($view=='inbox'?'  class="active"':'');?>><a href="<?php echo(JRoute::_('index.php?option=com_angelgirls&view=inbox&task=inboxMensagens',false));?>"><span class="caixaMensagens"></span> <span class="hidden-phone"> Messages</span></a>
