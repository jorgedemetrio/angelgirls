...
/**
 * DadosComplementares View
 */
class AngelgirlsViewdadoscomplementares extends JViewLegacy
{
	/**
	 * DadosComplementares view display method
	 * @return void
	 */
	function display($tpl = null) 
	{
		// Include helper submenu
		AngelgirlsHelper::addSubmenu('dadoscomplementares');
