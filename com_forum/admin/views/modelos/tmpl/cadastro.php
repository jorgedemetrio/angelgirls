		...
		<?php if( isset($this->item) && isset($this->item->id)){ ?>
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'redesSociais','Redes Sociais'); ?>
				...
				<div class="row-fluid">
					...
					<table class="admintable" align="center">
						<tr>
							<th align="center" colspan="1" class="key"><label for="rede"> <?php echo JText::_('Rede'); ?></label></th>
							<th align="center" colspan="2" class="key"><label for="contato"> <?php echo JText::_('Contato'); ?></label></th>
							<th align="center" colspan="1" class="key"><label for="principal"> <?php echo JText::_('Principal'); ?></label></th>
						</tr>
						<tr>
							<td colspan="1" align="center">
								<select name="rede" id="rede" style="width: 270px;">
									<option></option>
							...
							<td colspan="2" align="center"><input style="width: 270px;" type="text" name="contato" id="contato" size="32" maxlength="250" /></td>
							<td colspan="2" align="center"><input type="checkbox" name="principal" id="principal" value="S"/></td>
						</tr>
						<tr>
							<td align="right"><button name="adicionarRedeSocial" id="adicionarRedeSocial" class="btn"/></td>
						</tr>
					</table>
