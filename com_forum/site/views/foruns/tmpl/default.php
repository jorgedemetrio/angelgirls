			...
			<div class="tab-content" style="overflow: auto;">
				...
				<div id="fotos" class="tab-pane fade">
					...
					<div class="row hidden-phone">
							<div class="col col-xs-12 col-sm-6 col-md-4 col-lg-4 text-center"><label class="control-label"  for="foto_perfil"> <?php echo JText::_('Foto perfil'); ?></label></div>
<?php	if($this->item->tipo=='MODELO') : ?>
...
<?php endif;?>							
					...
					<div class="row">
						<div class="col col-xs-12 col-sm-6 col-md-4 col-lg-4 text-center">
							...
							<input style="width: 90%;" type="file"  name="foto_perfil" id="foto_perfil" accept="image/*"   data-validation-max-size="3M" class="form-control" data-validation="size" data-validation-max-size="3M" data-validation-allowing="jpg, png, gif" data-validation-dimension="min300x500"/>
						</div>
		<?php	if($this->item->tipo=='MODELO') : ?>
						<div class="col col-xs-12 col-sm-6 col-md-4 col-lg-4 text-center">
							...
							<input style="width: 90%;" type="file" name="foto_inteira" id="foto_inteira" accept="image/*"  data-validation-max-size="3M" data-validation-allowing="jpg, png, gif" data-validation-dimension="min300x500"/>
						</div>					
						<div class="col col-xs-12 col-sm-6 col-md-4 col-lg-4 text-center">
							...
							<input style="width: 90%;" type="file" name="foto_inteira_horizontal" id="foto_inteira_horizontal" accept="image/*"  data-validation-max-size="3M" data-validation-allowing="jpg, png, gif" />
						</div>
		<?php endif;?>
					</div>
				</div>
