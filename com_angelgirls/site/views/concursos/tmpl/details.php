<?php
/**
 * Concursos HTML Details Template
 *
 * PHP versions 5
 *
 * @category  Template
...
<tr>
    ...
    <td><?php echo $this->item->premio; ?></td></tr>
<tr>
    <th><?php echo JText::_('Cadastro Valido'); ?></th>
    <td><?php echo $this->item->cadastro_valido; ?></td></tr>
<tr>
    <th><?php echo JText::_('Votos Validos'); ?></th>
    <td><?php echo $this->item->votos_validos; ?></td></tr>
<tr>
...
<?php else : ?>
    <p><?php echo JText::_('Concursos not found'); ?>.</p>
<?php endif; ?>