...
<h1><?php echo JText::_('Sessoes'); ?></h1>
<?php if(count($this->items) > 0) : ?>
<div id="sessoes_list">
    <p><?php echo JText::_('Below is a list of all current Sessoes'); ?>.</p>
    ...
    <?php $link = JRoute::_('index.php?option=com_angelgirls&amp;view=sessoes&amp;layout=details&amp;id='.$item->id); ?>
        <tr>
...
<?php else: ?>
    <p><?php echo JText::_('No Sessoes found'); ?>.</p>
<?php endif; ?>
</div>