...
<tr>
    ...
    <td><?php echo $this->item->documento; ?></td></tr>
<tr>
    <th><?php echo JText::_('Foto Perfil'); ?></th>
    <td><?php echo $this->item->foto_perfil; ?></td></tr>
<tr>
    <th><?php echo JText::_('Apelido'); ?></th>
    <td><?php echo $this->item->apelido; ?></td></tr>
<tr>
    <th><?php echo JText::_('Tipo Perfil'); ?></th>
    <td><?php echo $this->item->tipo_perfil; ?></td></tr>
<tr>
    <th><?php echo JText::_('Published'); ?></th>
    <td><?php echo $this->item->published; ?></td></tr>
<tr>
    <th><?php echo JText::_('Status'); ?></th>
    <td><?php echo $this->item->status; ?></td></tr>
<tr>
...
<?php else : ?>
    <p><?php echo JText::_('Perfils not found'); ?>.</p>
<?php endif; ?>