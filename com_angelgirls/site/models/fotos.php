...
class AngelGirlsModelFotos extends JModelLegacy
{
    ...
    public function getItem()
    {
        ...
        $this->_db->setQuery("SELECT * FROM `#__angelgirls_fotos` WHERE `id` = $id AND `published` = 1 ");
    ...
    {
        $this->_items = $this->_getList('SELECT * FROM `#__angelgirls_fotos` WHERE `published` = 1 ');
