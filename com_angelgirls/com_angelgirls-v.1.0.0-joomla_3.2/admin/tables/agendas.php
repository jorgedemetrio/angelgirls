 ...
 * @version   1.0.0
 */
class JTableAgendas extends JTable
{
    /**
     * @var int Primary key
     */
    ...
    {
        parent::__construct('#__angelgirls_agendas', 'id', $db);
    }
    ...
    public function check()
    {
        ...
        $required_fields = array('nome' => 'Nome', 'descricao_google' => 'Descricao Google', 'data' => 'Data', 'created_on' => 'Created On', 'edited_on' => 'Edited On', 'publicar' => 'Publicar', 'despublicar' => 'Despublicar', 'id_created_by' => 'Id Created By', 'id_edited_by' => 'Id Edited By');
