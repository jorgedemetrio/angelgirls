    ...
    <div id="editcell">
        ...
        <?php
            ...
            foreach($this->items as $row)
            {
                ...
                $link = JRoute::_('index.php?option=com_angelgirls&view=galerias&task=edit&cid[]='. $row->id);
        ?>
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td><?php echo $checked; ?></td>
                       ...
                       <td><?php echo "<a href='$link'>".$row->id_concurso."</a>"; ?></td>
                       <td><?php echo "<a href='$link'>".$row->id_sessao."</a>"; ?></td>
                       ...
                       <td><?php echo "<a href='$link'>".$row->grande."</a>"; ?></td>
                       <td><?php echo "<a href='$link'>".$row->thumb."</a>"; ?></td>
                       <td><?php echo "<a href='$link'>".$row->icone."</a>"; ?></td>
                       <td><?php echo "<a href='$link'>".$row->media."</a>"; ?></td>
