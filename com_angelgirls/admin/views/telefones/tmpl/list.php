    ...
    <div id="editcell">
        ...
        <?php
            ...
            foreach($this->items as $row)
            {
                ...
                $link = JRoute::_('index.php?option=com_angelgirls&view=telefones&task=edit&cid[]='. $row->id);
        ?>
                <tr class="<?php echo "row$k"; ?>">
                    <td><?php echo $row->id; ?></td>
                    <td><?php echo $checked; ?></td>
                       <td><?php echo "<a href='$link'>".$row->user_id."</a>"; ?></td>
                       <td><?php echo "<a href='$link'>".$row->telefone."</a>"; ?></td>
                       <td><?php echo "<a href='$link'>".$row->ddd."</a>"; ?></td>
