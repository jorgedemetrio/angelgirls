    ...
    <div id="editcell">
        ...
        <thead>
            <tr>
                ...
                <th width="20"><input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count($this->items); ?>);" /></th>
                  ...
                  <th><?php echo JText::_('Premio'); ?></th>
                  <th><?php echo JText::_('Cadastro Valido'); ?></th>
                  <th><?php echo JText::_('Votos Validos'); ?></th>
        ...
        <?php
            ...
            foreach($this->items as $row)
            {
                ...
                $link = JRoute::_('index.php?option=com_angelgirls&view=concursos&task=edit&cid[]='. $row->id);
        ?>
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td><?php echo $checked; ?></td>
                       ...
                       <td><?php echo "<a href='$link'>".$row->premio."</a>"; ?></td>
                       <td><?php echo "<a href='$link'>".$row->cadastro_valido."</a>"; ?></td>
                       <td><?php echo "<a href='$link'>".$row->votos_validos."</a>"; ?></td>
