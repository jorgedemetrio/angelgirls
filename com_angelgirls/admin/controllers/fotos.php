<?php
/**
 * Fotos Controller of the AngelGirls Component
 *
 * PHP versions 5
 *
 * @category  Controller
...
/**
 * AngelGirls Component Fotos Controller
 *
 * @category Controller
 * @package  AngelGirls
 * @author   Jorge Demetiro <jorge.demetrio@alldreams.com.br>
 ...
 * @since    1.0
 */
class AngelGirlsControllerFotos extends AngelGirlsController
{
    /**
     * Constructor
     *
    ...
    public function save()
    {
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_angelgirls&view=Fotos&layout=list', false), $msg);
    }
    ...
    public function publish()
    {
        ...
        if (count($cid) > 0) {
            $table =& $this->getModel('Fotos')->getTable('Fotos', 'JTable');
            $table->publish($cid, $publish);
        }
        $this->setRedirect('index.php?option=com_angelgirls&view=Fotos&layout=list');
    }
