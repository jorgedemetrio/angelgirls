<?php
/**
 * Telefones Controller of the AngelGirls Component
 *
 * PHP versions 5
 *
 * @category  Controller
...
/**
 * AngelGirls Component Telefones Controller
 *
 * @category Controller
 * @package  AngelGirls
 * @author   Jorge Demetiro <jorge.demetrio@alldreams.com.br>
 ...
 * @since    1.0
 */
class AngelGirlsControllerTelefones extends AngelGirlsController
{
    /**
     * Constructor
     *
    ...
    {
        JRequest::setVar('view', 'Telefones');
    ...
    {
        $model = $this->getModel('Telefones');
        if ($model->save()) {
            $msg = JText::_('Object saved successfully!');
        } else {
            $msg = JText::_('Error: '.$model->getError());
        }
        $this->setRedirect(JRoute::_('index.php?option=com_angelgirls&view=Telefones&layout=list', false), $msg);
    }
