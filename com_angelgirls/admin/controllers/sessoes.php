...
class AngelGirlsControllerSessoes extends AngelGirlsController
{
    ...
    public function save()
    {
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_angelgirls&view=Sessoes&layout=list', false), $msg);
    }
    ...
    public function publish()
    {
        ...
        if (count($cid) > 0) {
            $table =& $this->getModel('Sessoes')->getTable('Sessoes', 'JTable');
            $table->publish($cid, $publish);
        }
        $this->setRedirect('index.php?option=com_angelgirls&view=Sessoes&layout=list');
    }
