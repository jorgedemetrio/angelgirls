<?php
/**
 * Emails Controller of the AngelGirls Component
 *
 * PHP versions 5
 *
 * @category  Controller
...
/**
 * AngelGirls Component Emails Controller
 *
 * @category Controller
 * @package  AngelGirls
 * @author   Jorge Demetiro <jorge.demetrio@alldreams.com.br>
 ...
 * @since    1.0
 */
class AngelGirlsControllerEmails extends AngelGirlsController
{
    /**
     * Constructor
     *
    ...
    public function save()
    {
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_angelgirls&view=Emails&layout=list', false), $msg);
    }
